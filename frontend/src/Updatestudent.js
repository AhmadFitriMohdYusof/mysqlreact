...
function Updatestudent() {
    ...
    function handleSubmit(e) {
        ...
        axios.put('http://localhost:4000/update/' + id, { name, email, marks, grade, city }) // Send a PUT request to update the student data
            .then(res => {
                ...
                <form onSubmit={handleSubmit}> {/* Form submission triggers handleSubmit function */}
                    ...
                    <div className='mb-3'>
                        ...
                        <input
                            type='text'
                            className='form-control'
                            value={marks} // Bind input value to email state
                            onChange={(e) => setMarks(e.target.value)} // Update email state when input changes
                        />
                    </div>
                    <div className='mb-3'>
                        <label>Grade</label>
                        <input
                            type='text'
                            className='form-control'
                            value={grade} // Bind input value to email state
                            onChange={(e) => setGrade(e.target.value)} // Update email state when input changes
                        />
                    </div>
                    <div className='mb-3'>
                        <label>City</label>
                        <input
                            type='text'
                            className='form-control'
                            value={city} // Bind input value to email state
                            onChange={(e) => setCity(e.target.value)} // Update email state when input changes
                        />
                    </div>
